  ...
  <div className="container-fluid h-custom">
    <div className="row d-flex justify-content-center align-items-center h-100">
      ...
      <form onSubmit={handleSubmit}>
                   ...
                   {error.email && <span>This field is required</span>}<br ></br>
                  <input
                      name='password'
                      type='password'
                       onChange={handleOnChange}
                   ...
                   {error.password && <span>This field is required</span>}<br></br>
                  <input
                      className="mb-3"
                      style={{ width: '40%', backgroundColor: 'black', border: 'none', padding: '10px', borderRadius: '5px', color: 'white', marginBottom: '20px' }}
                        type="submit" />
                </form>
                <NavLink to="/register">
                     <span>New User?</span>
